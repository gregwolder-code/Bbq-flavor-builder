...
function BuilderPageContent() {
  ...
  const timeOptions = [
    ...
    { id: "standard", name: "Standard", description: "1-3 hours total" },
    { id: "weekend", name: "Weekend", description: "3-6 hours total" },
    { id: "low-slow", name: "Low & Slow", description: "6+ hours total" },
  ];
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="min-h-[400px]">
        ...
        {step === 3 && (
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <h2 className="text-2xl font-semibold text-center">Step 3: How Much Time Do You Have?</h2>
            <TimeSelector
              options={timeOptions}
              selectedId={selectedTime || undefined}
              onSelect={(id) => {
                setSelectedTime(id);
                setTimeout(nextStep, 300);
              }}
        ...
        {step === 4 && (
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <h2 className="text-2xl font-semibold text-center">Step 4: Pick Your Flavor</h2>
            <FlavorSelector
